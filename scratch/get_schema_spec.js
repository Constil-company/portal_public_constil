...
async function getOpenApiSpec() {
  try {
    ...
    const companyProfiles = response.data.definitions.company_profiles;
    console.log('Company Profile columns:', Object.keys(companyProfiles.properties));
  } catch (error) {
    console.log('Error fetching OpenAPI spec:', error.message);
  }
}
